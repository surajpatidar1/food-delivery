...
toast.error(response.data.message)}
  ...
  return (
    <div className='add'>
      <form className='flex-col' onSubmit={onSubmitHandler} content='multipart/form-data' >
...
<input onChange={changeHandler} value={data.name} type="text" name='name' placeholder='Type here' />
   ...
   <div className="add-product-description flex-col">
    ...
    <textarea onChange={changeHandler} value={data.description} type="text"  name='description' rows='6'  placeholder='Type here'/>
   </div>
